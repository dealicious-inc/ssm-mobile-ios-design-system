...
struct EmptyViewTest: View {
    var defaultViewModel = DLEmptyViewModel(
    ...
    var subtitleViewModel = DLEmptyViewModel(
        iconImage: nil,
        subtitle: "등록된 상품이 없어요."
    )
    
    var iconWithSubtitleViewModel = DLEmptyViewModel(
        subtitle: "데이터를 불러오지 못했어요.\n네트워크 확인 후 새로고침 버튼을 눌러주세요."
    )
    
    var iconWithSubtitleAndButtonViewModel = DLEmptyViewModel(
        subtitle: "데이터를 불러오지 못했어요.\n네트워크 확인 후 새로고침 버튼을 눌러주세요.",
        buttonTitle: "재시도"
    )
    
    var longButtonTitleViewModel = DLEmptyViewModel(
        subtitle: "데이터를 불러오지 못했어요.\n네트워크 확인 후 새로고침 버튼을 눌러주세요.",
