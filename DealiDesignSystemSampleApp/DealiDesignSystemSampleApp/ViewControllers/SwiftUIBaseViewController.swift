...
final class SwiftUIBaseViewController: UIViewController {
    ...
    private func addComponentsButtons() {
        ...
        self.addComponents(title: "CollectionView", actionSelector: #selector(CollectionViewButtonPressed))
    }
}
...
extension SwiftUIBaseViewController {
    ...
    @objc func CollectionViewButtonPressed() {
        self.pushViewController(CollectionViewTestViewController())
    }
}
