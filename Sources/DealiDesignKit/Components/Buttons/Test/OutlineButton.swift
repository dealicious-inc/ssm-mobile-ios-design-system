...
public class OutlineButton: UIButton {
    ...
    public var color: OutlineColorType
    public var size: OutlineSizeType
    ...
    public init(color: OutlineColorType, size: OutlineSizeType, title: String? = "") {
        self.color = color
        self.size = size
        self.title = title
